...
test('inspect', function (t) {
    ...
    var obj = [{ inspect: function xyzInspect() { return '!XYZÃÂÃÂ¡'; } }, []];
    var stringResult = '[ !XYZÃÂÃÂ¡, [] ]';
...
test('maxStringLength', function (t) {
    ...
    t.equal(
        ...
        '[ \'' + str + '\' ]',
        'maxStringLength option accepts ÃÂ¢ÃÂÃÂ'
    );
