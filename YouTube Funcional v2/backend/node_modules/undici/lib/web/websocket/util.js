...
function fireEvent (e, target, eventFactory = (type, init) => new Event(type, init), eventInitDict = {}) {
  ...
  // 3. Initialize eventÃÂ¢ÃÂÃÂs type attribute to e.
...
function getURLRecord (url, baseURL) {
  ...
  // 3. If urlRecord ÃÂ¢ÃÂÃÂs scheme is " http ", then set urlRecord ÃÂ¢ÃÂÃÂs scheme to " ws ".
  // 4. Otherwise, if urlRecord ÃÂ¢ÃÂÃÂs scheme is " https ", set urlRecord ÃÂ¢ÃÂÃÂs scheme to " wss ".
  ...
  // 5. If urlRecord ÃÂ¢ÃÂÃÂs scheme is not " ws " or " wss ", then throw a " SyntaxError " DOMException .
  if (urlRecord.protocol !== 'ws:' && urlRecord.protocol !== 'wss:') {
    throw new DOMException('expected a ws: or wss: url', 'SyntaxError')
  }

  // If urlRecord ÃÂ¢ÃÂÃÂs fragment is non-null, then throw a " SyntaxError " DOMException .
