...
function establishWebSocketConnection (url, protocols, client, handler, options) {
  // 1. Let requestURL be a copy of url, with its scheme set to "http", if urlÃÂ¢ÃÂÃÂs
  ...
  // 3. Append (`Upgrade`, `websocket`) to requestÃÂ¢ÃÂÃÂs header list.
  // 4. Append (`Connection`, `Upgrade`) to requestÃÂ¢ÃÂÃÂs header list.
  ...
  // 6. Append (`Sec-WebSocket-Key`, keyValue) to requestÃÂ¢ÃÂÃÂs
  //    header list.
  request.headersList.append('sec-websocket-key', keyValue, true)

  // 7. Append (`Sec-WebSocket-Version`, `13`) to requestÃÂ¢ÃÂÃÂs
  //    header list.
  request.headersList.append('sec-websocket-version', '13', true)

  // 8. For each protocol in protocols, combine
  //    (`Sec-WebSocket-Protocol`, protocol) in requestÃÂ¢ÃÂÃÂs header
  //    list.
  ...
  const controller = fetching({
    ...
    processResponse (response) {
      ...
      //    list values given `Sec-WebSocket-Protocol` and responseÃÂ¢ÃÂÃÂs
...
function closeWebSocketConnection (object, code, reason, validate = false) {
  ...
  //     - If objectÃÂ¢ÃÂÃÂs ready state is CLOSING (2) or CLOSED (3)
  ...
  if (isClosed(object.readyState) || isClosing(object.readyState)) {
    ...
    // Fail the WebSocket connection and set objectÃÂ¢ÃÂÃÂs ready state to CLOSING (2). [WSP]
    ...
    // Set objectÃÂ¢ÃÂÃÂs ready state to CLOSING (2).
    object.readyState = states.CLOSING
  }
}
