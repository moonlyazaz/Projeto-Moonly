...
class WebSocket extends EventTarget {
  ...
  send (data) {
    ...
    if (typeof data === 'string') {
      ...
      // by the length of dataÃÂ¢ÃÂÃÂs buffer in bytes.
      ...
      // of the Blob objectÃÂ¢ÃÂÃÂs raw data, in bytes.
  ...
  #onConnectionEstablished (response, parsedExtensions) {
    ...
    // 2. Change the extensions attributeÃÂ¢ÃÂÃÂs value to the extensions in use, if
    ...
    // 3. Change the protocol attributeÃÂ¢ÃÂÃÂs value to the subprotocol in use, if
    //    it is not the null value.
  ...
  #onMessage (type, data) {
    ...
    //    objectÃÂ¢ÃÂÃÂs url's origin, and the data attribute initialized to dataForEvent.
