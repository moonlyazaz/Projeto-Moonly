...
function multipartFormDataParser (input, mimeType) {
  // 1. Assert: mimeTypeÃÂ¢ÃÂÃÂs essence is "multipart/form-data".
  assert(mimeType !== 'failure' && mimeType.essence === 'multipart/form-data')

  const boundaryString = mimeType.parameters.get('boundary')

  // 2. If mimeTypeÃÂ¢ÃÂÃÂs parameters["boundary"] does not exist, return failure.
  //    Otherwise, let boundary be the result of UTF-8 decoding mimeTypeÃÂ¢ÃÂÃÂs
  //    parameters["boundary"].
      ...
      case 'content-disposition': {
        ...
        while (
          ...
          if (attribute.name === 'name') {
            ...
            // Per RFC 5987 ÃÂÃÂ§4.1, when both legacy and extended forms of the
