...
function extractBody (object, keepalive = false) {
  ...
  if (webidl.is.ReadableStream(object)) {
    ...
    //    result of running objectÃÂ¢ÃÂÃÂs get stream.
  ...
  if (typeof object === 'string') {
    ...
    // Set source to the result of running the application/x-www-form-urlencoded serializer with objectÃÂ¢ÃÂÃÂs list.
    ...
    /*! formdata-polyfill. MIT License. Jimmy WÃÂÃÂ¤rting <https://jimmy.warting.se/opensource> */
    const formdataEscape = (str) =>
      str.replace(/\n/g, '%0A').replace(/\r/g, '%0D').replace(/"/g, '%22')
    const normalizeLinefeeds = (value) => value.replace(/\r?\n|\r/g, '\r\n')

    // Set action to this step: run the multipart/form-data
    // encoding algorithm, with objectÃÂ¢ÃÂÃÂs entry list and UTF-8.
    ...
    // Set length to objectÃÂ¢ÃÂÃÂs size.
    length = object.size

    // If objectÃÂ¢ÃÂÃÂs type attribute is not the empty byte sequence, set
    // type to its value.
    if (object.type) {
      type = object.type
    }
  ...
  // step that returns source and length to sourceÃÂ¢ÃÂÃÂs length.
...
function cloneBody (body) {
  ...
  // 1. Let ÃÂÃÂ« out1, out2 ÃÂÃÂ» be the result of teeing bodyÃÂ¢ÃÂÃÂs stream.
  const { 0: out1, 1: out2 } = body.stream.tee()

  // 2. Set bodyÃÂ¢ÃÂÃÂs stream to out1.
  body.stream = out1
...
function bodyMixinMethods (instance, getInternalState) {
  const methods = {
    blob () {
      ...
      // contents are bytes and whose type attribute is thisÃÂ¢ÃÂÃÂs
      // MIME type.
    ...
    formData () {
      ...
      return consumeBody(this, (value) => {
        ...
        // 2. If mimeType is non-null, then switch on mimeTypeÃÂ¢ÃÂÃÂs essence and run
    ...
    bytes () {
      ...
      // result of creating a Uint8Array from bytes in thisÃÂ¢ÃÂÃÂs relevant realm.
      return consumeBody(this, (bytes) => {
...
function consumeBody (object, convertBytesToJSValue, instance, getInternalState) {
  ...
  // 5. If objectÃÂ¢ÃÂÃÂs body is null, then run successSteps with an
  //    empty byte sequence.
  if (object.body == null) {
  ...
  // 6. Otherwise, fully read objectÃÂ¢ÃÂÃÂs body given successSteps,
  //    errorSteps, and objectÃÂ¢ÃÂÃÂs relevant global object.
...
function bodyUnusable (object) {
  ...
  // its bodyÃÂ¢ÃÂÃÂs stream is disturbed or locked.
...
function bodyMimeType (requestOrResponse) {
  ...
  // 2. If requestOrResponse is a Request object, then set headers to requestOrResponseÃÂ¢ÃÂÃÂs requestÃÂ¢ÃÂÃÂs header list.
  // 3. Otherwise, set headers to requestOrResponseÃÂ¢ÃÂÃÂs responseÃÂ¢ÃÂÃÂs header list.
