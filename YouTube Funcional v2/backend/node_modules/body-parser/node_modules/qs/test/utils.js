...
test('encode', function (t) {
    ...
    t.equal(
        utils.encode('abc 123 ÃÂ°ÃÂÃÂÃÂ©', null, 'iso-8859-1'),
    ...
    t.equal(
        utils.encode('ÃÂÃÂÃÂ¡ÃÂÃÂÃÂ¯ÃÂ¤ÃÂ'),
